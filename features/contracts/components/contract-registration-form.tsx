...
export function ContractRegistrationForm({ listings, consultations, sourceConsultationId = "" }: { listings: ContractOption[]; consultations: ContractOption[]; sourceConsultationId?: string }) {
  const router = useRouter();
  const form = useForm<ContractCreateInput>({ resolver: zodResolver(contractCreateSchema), defaultValues: { ...empty, sourceConsultationId } });
