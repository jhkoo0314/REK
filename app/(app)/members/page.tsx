...
export default async function MembersPage() {
  const { context, members, errorMessage } = await getStaffPermissions();
  ...
  return <><PageHeader title="멤버 권한" description="직원별로 민감정보를 볼 수 있는 범위를 정합니다." /><SensitivePermissionsWorkspace members={members} errorMessage={errorMessage} /></>;
}
