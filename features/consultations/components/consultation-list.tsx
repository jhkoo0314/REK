...
const filters: Array<ConsultationStage | "전체" | "오늘 연락" | "지연"> = ["전체", "오늘 연락", "지연", "상담 진행", "방문 예정"];
