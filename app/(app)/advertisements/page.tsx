...
export default async function AdvertisementsPage({ searchParams }: { searchParams: Promise<{ month?: string; view?: string }> }) {
  ...
  return <><PageHeader title="광고 관리" description={headerDescription} /><div className="space-y-6"><AdvertisementViewSwitcher activeView={activeView} /><AdvertisingCopyWorkspace /></div></>;
}
